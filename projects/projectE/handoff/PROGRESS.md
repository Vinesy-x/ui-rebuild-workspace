...
> 这一段曾是独立的 `AUDIT_PROTOCOL.md` · 2026-05-21 起合并进 PROGRESS · 少一份必拉文档。
...
工作集 ~50 文件 · ~800KB · ~195K tokens · 含 PROGRESS + spec/ 6 + preview/ 2 + final/src/ 全套。
沙箱与 GitHub 不一致全覆盖 → 以 GitHub 为准。
⚠️ 不要拉 `projects/projectE/_internal/`。
...
- 13 共享 modal + 4 全局 modal 全数 alive(无 dead click)

### 步骤 3 · 任务 B · preview/ 清理建议

`handoff/preview/Style Lock · 风格定档.html` vs canonical 全集 `handoff/preview/大掌柜.html`:
- 27 古风对照表 / 15 色 swatch / 8 字阶 scale / motion 体系 → 仍是不可替代速查?
